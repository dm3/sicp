...
;; We have two ways of calculating the result:
...
;; `par1` and `par2` do indeed return different results. Question is, which one
...
;;
;; 1. ([lr1, ur1] * [lr2, ur2]) / ([lr1, ur1] + [lr2, ur2])
;; 2. [(lr1 * lr2), (ur1 * ur2)] / [(lr1 + lr2), (ur1 + ur2)]
;; 3. [((lr1 * lr2) * (1 / (ur1 + ur2))), ((ur1 * ur2) * (1 / (lr1 + lr2)))]
;; 4. [(lr1 * lr2) / (ur1 + ur2), (ur1 * ur2) / (lr1 + lr2)]
;;
;; `par2`:
;;
;; 1. [1, 1] / (([1, 1] / [lr1, ur1]) + ([1, 1] / [lr2, ur2]))
;; 2. [1, 1] / ([(1 / ur1), (1 / lr1)] + [1 / ur2, 1 / lr2])
;; 3. [1, 1] / [(1 / ur1) + (1 / ur2), (1 / lr1) + (1 / lr2)]
;; 4. [1 / ((1 / lr1) + (1 / lr2)), 1 / ((1 / ur1) + (1 / ur2))]
;;
